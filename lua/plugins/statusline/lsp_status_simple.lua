-- Forked from lualine's lsp_status
...
local default_options = {
  ...
  ignore_lsp = {},
  display_mode = 'names', -- names | count
}
...
function M:update_status()
  ...
  for _, client in ipairs(clients) do
    ...
    if self.options.display_mode == 'names' then
  ...
  if done_count + silent_count == clients_count then
